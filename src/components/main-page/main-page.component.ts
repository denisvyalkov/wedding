...
export class WedMainPageComponent {
  ...
  faqItems = [
    ...
    },
    {
      ...
      content:
        'Мы просим сохранить наше право на спонтанный, а не «заказной» поцелуй.' +
        'Но если эмоции переполняют и крик «Горько!» рвется наружу — пожалуйста, будьте готовы пополнить наш свадебный фонд 😉.' +
        'Стоимость первого выкрика — 1000 рублей. Все последующие — 2000 рублей.  Все собранные средства пойдут на осуществление нашей мечты.',
      expanded: false,
      new: true,
    },
    {
