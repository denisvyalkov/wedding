...
export class WedMainPageComponent {
  ...
  faqItems = [
    ...
    },
    {
      ...
      content:
        'На нашем торжестве просим сохранить наше право на спонтанный, а не «заказной» поцелуй.' +
        'Но если эмоции переполняют и крик «Горько!» рвется наружу — пожалуйста, будьте готовы пополнить наш свадебный фонд 😉.' +
        'Стоимость одного выкрика — 1000 рублей. Все собранные средства пойдут на осуществление нашей маленькой мечты.',
      expanded: false,
      new: true,
    },
    {
