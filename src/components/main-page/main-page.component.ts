...
export class WedMainPageComponent {
  ...
  faqItems = [
    ...
    },
    {
      ...
      content:
        'Будем безмерно благодарны, если вы сохраните наше право на спонтанный, а не «заказной» поцелуй. Но если эмоции переполняют и крик «Горько!» рвется наружу — пожалуйста, будьте готовы пополнить наш свадебный фонд 😉. Стоимость одного выкрика — 5000 рублей. Все собранные средства пойдут на осуществление нашей маленькой мечты.',
      expanded: false,
    },
    {
